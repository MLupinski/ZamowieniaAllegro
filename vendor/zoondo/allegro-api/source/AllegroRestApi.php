...
class AllegroRestApi
{
    ...
    public static function generateToken($code, $clientId, $clientSecret, $redirectUri)
    {
        ...
        // Returning response
        return $api->sendRequest("https://allegro.pl.allegrosandbox.pl/auth/oauth/token"
    ...
    public static function refreshToken($refreshToken, $clientId, $clientSecret, $redirectUri)
    {
        ...
        // Returning response
        return $api->sendRequest("https://api.allegro.pl.allegrosandbox.pl/auth/oauth/token"
